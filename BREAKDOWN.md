...
│   └── 📁 chromadb/   #  Database Vector cục bộ (Chứa dữ liệu đã nhúng)
├── .gitignore         #  File chặn đụng hàng đẩy lên Github (chặn venv, chromadb)
...
###  `data/dataset.xlsx` và `data/chromadb/`
