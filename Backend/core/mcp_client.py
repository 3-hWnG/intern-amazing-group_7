"""Client MCP — giữ MỘT phiên kết nối lâu dài tới MCP search server.
    ...
    MCP_TRANSPORT=stdio   app tự bật Backend/mcp_search/server.py làm tiến trình con (mặc định)
...
from config import (BACKEND_DIR, MCP_FALLBACK_DIRECT, MCP_SERVER_URL, MCP_TIMEOUT,
                    MCP_TRANSPORT, PROJECT_ROOT)

SERVER_SCRIPT = BACKEND_DIR / "mcp_search" / "server.py"
_STOP = "__stop__"
_PING = "__ping__"
