...
from config import DB_BACKEND, DB_PATH, SCHEMA_PATH
...
if DB_BACKEND != "sqlite":
    # Cổng đổi CSDL: viết bản mới NGAY TRONG tệp này rồi bỏ dòng raise đi.
    raise NotImplementedError(
        f"DB_BACKEND={DB_BACKEND!r} chưa được cài đặt. Hiện chỉ có 'sqlite'. "
        "Viết bản mới trong Backend/db/connection.py + repositories.py.")
